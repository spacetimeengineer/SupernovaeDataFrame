...
class SupernovaeDataFrame:
    def __init__(self, file_path):
        ...
        self.universe_age_sec = (
            13_787_000_000 * self.seconds_per_year
        )  # Cosmic time in seconds
        self.speed_of_light_kmps = 299_792.458  # Speed of light in km/s
        self.universe_radius_km = (
            self.speed_of_light_kmps * self.universe_age_sec
        )  # Radius in km
        self.universe_radius_ly = (
            self.universe_radius_km / 9_460_730_472_580.8
    ...
    def _load_data(self, file_path):
        ...
        with open(file_path, "r") as file:
            ...
            for line in file:
                ...
                d_comoving_ly = (
                    d_comoving_mpc * 3.26
                )  # Convert comoving distance to million light-years

                # Velocity and universe age calculations
                velocity_fraction = (1 - 1 / (z + 1) ** 2) ** 0.5
                velocity_kmps = (
                    velocity_fraction * self.speed_of_light_kmps
                )  # Velocity in km/s
                redshift_velocity = self.speed_of_light_kmps * z  # Redshift velocity
                age_of_universe_at_emission = self.universe_age_sec / (
                    z + 1
